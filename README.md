...
一本給初學者的 React 入門教學書，由淺入深學習 ReactJS 生態系 (Flux, Redux, React Router, React Native, etc.)，打造跨平台應用程式。本書全書範例都將以 ES6+ 撰寫，若需參考 ES5 撰寫方式，請參考附錄一的 React ES5、ES6+ 常見用法對照表。
